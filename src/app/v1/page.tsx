...
export default function V1() {
  return (
    <main style={{ fontFamily: "var(--font-inter), sans-serif", background: '#FDF8F5', color: '#1A0D13', overflowX: 'hidden' }}>
      ...
      {/* HERO — fundo berry + logo + headline + CTA */}
      <section style={{ background: '#8B1C5A', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: '80px 24px', position: 'relative', overflow: 'hidden' }}>
